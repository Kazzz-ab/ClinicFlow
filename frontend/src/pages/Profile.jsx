...
export default function Profile() {
  ...
  const inputClass = "w-full px-4 py-2.5 rounded-xl border border-[#E2E8F0] bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#0077B6]/20 focus:border-[#0077B6]";
          ...
          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-[#F1F5F9]">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                <Shield size={13} style={{ color: '#0077B6' }} />
                <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: '#0077B6', textTransform: 'capitalize' }}>
                  {authUser?.role || 'staff'}
                </span>
              </div>
            </div>
