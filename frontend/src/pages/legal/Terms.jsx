  ...
  return (
    <div className="min-h-screen py-16 px-6" style={{ background: 'var(--bg)' }}>
      <div className="max-w-3xl mx-auto">
        <Link to="/" className="flex items-center gap-2 text-[#059669] hover:underline mb-8 text-sm" style={{ fontFamily: 'var(--font-body)' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-2xl p-8 space-y-6" style={{ background: 'var(--surface)', border: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            {[
              { title: '1. Acceptance of Terms', body: 'By accessing Clinio, you agree to these Terms of Service. If you do not agree, do not use the system. These terms apply to all staff members, administrators, and authorized users.' },
              { title: '2. Authorized Use', body: 'Clinio is for authorized clinic personnel only. Access credentials are personal and non-transferable. Users are responsible for all activity under their account. Sharing login credentials is strictly prohibited.' },
              ...
              { title: '5. System Availability', body: 'Clinio aims for 99.9% uptime but does not guarantee uninterrupted access. Scheduled maintenance will be communicated in advance. We are not liable for data loss resulting from system outages beyond reasonable backup procedures.' },
              { title: '6. Modifications', body: 'These terms may be updated at any time. Continued use of Clinio after changes constitutes acceptance of the revised terms.' },
            ].map(({ title, body }) => (
              <div key={title}>
