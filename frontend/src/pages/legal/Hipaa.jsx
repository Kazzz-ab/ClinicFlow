        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-2xl p-8 space-y-6" style={{ background: 'var(--surface)', border: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            {[
              ...
              { title: 'HOW WE PROTECT YOUR INFORMATION', body: 'Clinio uses administrative safeguards (policies and training), physical safeguards (secure facilities and access controls), and technical safeguards (encryption, audit logs, role-based access) to protect your health information.' },
