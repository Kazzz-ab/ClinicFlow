      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-2xl p-8 space-y-6" style={{ background: 'var(--surface)', border: '1px solid rgba(0,0,0,0.06)' }}>
            ...
            {[
              { title: '1. Information We Collect', body: 'Clinio collects patient demographic information, appointment records, medical billing data, and staff login credentials necessary for clinic operations. All data is stored securely in encrypted databases hosted on Supabase (PostgreSQL).' },
              ...
              { title: '4. HIPAA Compliance', body: 'Clinio operates in compliance with the Health Insurance Portability and Accountability Act (HIPAA). We implement required administrative, physical, and technical safeguards to protect Protected Health Information (PHI).' },
