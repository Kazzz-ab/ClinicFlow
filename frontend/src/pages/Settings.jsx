...
function PasswordSection() {
  ...
  const inputClass = "w-full pr-10 pl-4 py-2.5 rounded-xl border border-[#E2E8F0] bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#059669]/20 focus:border-[#059669]";
